...
if (process.env.NODE_ENV === "development") {
  ...
  auth0ManagementClient = new ManagementClient({
    ...
    token:
      "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6Imp6V2V3WGkyaV81WnpVSHpFZWwzRSJ9..GANvQckQu79gb2zSs--tYYgIll5qI82OIyrCgbWk9UsucNQmwjHrF-2F8iWighUwoxxV3gR7Q-z1s1sgTRnZKUAtlRrV-qhX5YmbPlOfZPEJrriaspei_ridJFgZLA-JSPQi8H0Doh_LsX_d8C16WZ0HizsOXsmzwrIK7GOWCoCW8EphzJTRLV0BZln5X5uhBPYqtbPY_ulNify6L0TYFAbHsvf8cmniReEoWfetrK2sU0ohv6sUOHUEV-vcfdbR2A9-Y5kyo1FgjjcT4eRTZXiO4ROh-TdC_g7AVlXh41FbjddfRVrX263WKphDi5DNkUmUfkCkFIE8mLyPLK8TvA", //-- 2023-06-04 --//
    telemetry: false,
