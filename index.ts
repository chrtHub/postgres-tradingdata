...
if (process.env.NODE_ENV === "development") {
  ...
  auth0ManagementClient = new ManagementClient({
    ...
    token:
      "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6Imp6V2V3WGkyaV81WnpVSHpFZWwzRSJ9..QLtaMCIm5stfLj0glPuvPnuVGFs-iQJFiz8dmPLl9wOay5hhFt1rIyz094nplH-tt-54pwnToqmxXVj9C-f4z5zq9tr3GbrjH1pr80CQsdyQk_83jC84q6kPqHLhw1-w0l5b_eWaWBebOAbUvoqBQW6PUENVmm0dSdJIpwya67ymOvHqF0Q-ZiYR4YEWwPd0LZ0nO95XzJfno8r08Izc5p_w38V5B742WwuKNSn53508_4emLzhzIwaYWVL0W0RTCbWhnmDEboj0pPx0axUbRs63SSbt9J5NMFGLOdsRgOKilA5RHj_A8H5s8S60KlLcaSeQSwH9ynzgWq3z9ACR3w",
    telemetry: false,
  });
}
