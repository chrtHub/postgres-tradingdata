...
if (process.env.NODE_ENV === "development") {
  ...
  auth0ManagementClient = new ManagementClient({
    ...
    token:
      "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6Imp6V2V3WGkyaV81WnpVSHpFZWwzRSJ9..a6ZI8PG8a_BbBFS67I0ZYIHY5Hu5ZATI68LMtlth39UEYKoA0m_pR79BJ-iE34dmAU_yPPwIzLSjhgq9T5WLLEDJGw9lI8eLim9mn9Xe77ckGxx2iJXj43bClCJR99jzIDHtTSYYiB7wVoEM5yiZRA7HEt-eULu6kJGA6Py-OFnRwAlZniduK0wAqYd8C-G5SKV10w8FxNdwIbM6SqFix6SJHyqCrZ3g6NCxOZfJvEM6bisVbQEjCygIfL9d1wu2_iYGrRTZdIR1kMYlZwOMtPxfuaF20wzhWRgy0WL6oOeCouX8dBPFPA3YT3DvGVzVxrPA0nyCzuTaiNjNKRVxbg",
    telemetry: false,
  });
}
