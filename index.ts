...
if (process.env.NODE_ENV === "development") {
  ...
  auth0ManagementClient = new ManagementClient({
    ...
    token:
      "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6Imp6V2V3WGkyaV81WnpVSHpFZWwzRSJ9..mBuZyAc362Cm5ieGMcObOxtM-ZmhWIvpnkg2PZM-9N1EeLI-y3uRKZ2IUTvdDuNc1yWrF5P3QGldE936SYwWVa--RQ8XMJo7xUOknfGW3QB7hdr1cMn5ODGbcBsEGAcYtkjRwj1zQN3Fum9ymxn_HAgD5X6LArdz9pY_qpYNg1cvp8d7VjSbxm7xha0YDtEArC1fgDaPSEm_H9A6kQK5amn2X2O3ISfQoeJADEvji_zDaXnIDVaxsGbCS8RPJAgZTlpPE9XBKsLLr9c6lCAdchaKAscg2npG2s8sYG5_kJ3zH9JA4y8kBWMF2-KpnrjwW5DoGcytpk2qZeHj0XHY6w",
    telemetry: false,
  });
}
