...
ssh -i "chrt-1-bastion-postgres-02.pem" -N -L 2222:db-instance-chrt-user-trading-data.cmlzf31dlxgq.us-east-1.rds.amazonaws.com:5432 ec2-user@18.207.101.199

##-- Check if tunnel is established on port 2222 --##
netstat -ntaP tcp | grep -i LISTEN | grep 2222a